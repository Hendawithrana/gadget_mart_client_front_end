<footer class="footer" style="background-color: #2f3946">
                ...
                <div class="col-lg-3 mb-2 mb-md-0">
                    <div class="widget">
                        ...
                        <ul class="contact-info">
                            <li>
                                <span class="contact-info-label">Address:</span> Sitina maluwa watta, <br> Samaghi Mawatha ,<br>Dondra,<br>Sri Lanka.
                            </li>
                            <li>
                                <span class="contact-info-label">Phone:</span><a href="tel:">+94 763871587</a>
                            </li>
                            <li>
                                <span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">hwrdilshan@gmail.com</a>
                            </li>
{{--                            <li>--}}
...
{{--                            </li>--}}
    ...
    <div class="footer-bottom">
        <div class="container d-flex justify-content-between align-items-center flex-wrap">
            <p class="footer-copyright py-3 pr-sm-4 pr-0 mb-0">Ramesh Dilshan. &copy; 2022. All Rights Reserved</p>
